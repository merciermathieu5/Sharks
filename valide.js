...
(async () => {
  ...
  tableauEgal(S.litTransac(), {partenaire:'DALLAS', sj:['Haydn Fleury'], part:['Kirby Dach']},
  ...
  tableauEgal(S.litTransac(), {partenaire:'DALLAS', sj:[], part:[]}, 'Le bouton Vider remet l\'échange à zéro');
